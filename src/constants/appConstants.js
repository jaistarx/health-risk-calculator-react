...
export const FOOD_HABITS = [
  ...
  },
  {
    ...
    rating: 1,
    description:
      "High-carb foods are dietary choices that are rich in carbohydrates, which are the body's primary source of energy. These foods typically include grains, legumes, fruits, and starchy vegetables like potatoes.",
  },
  {
    name: "Sugary and Oily Food",
    rating: 1,
    description:
      "Sugary foods are rich in sugars and can encompass a wide range of treats, from candy and pastries to sugary beverages. Oily foods are those that contain a high amount of fats and oils, often visible as a shiny or greasy texture. These foods can be both plant-based, like fried foods and certain snacks, or animal-based, such as fatty cuts of meat and oily fish like salmon. Both are often high in calories and low in nutritional value.",
  },
];
